...
customKeys c@(XConfig {modMask = modm}) = M.fromList $
    ...
    , ((controlMask,   xK_Down), spawn "xdotool mousemove_relative --   0  15")
    , ((controlMask,     xK_Up), spawn "xdotool mousemove_relative --   0 -15")
    , ((controlMask,   xK_Left), spawn "xdotool mousemove_relative -- -15   0")
    , ((controlMask,  xK_Right), spawn "xdotool mousemove_relative --  15   0")
    , ((controlMask, xK_Return), spawn "xdotool click 1")
    , ((controlMask .|. shiftMask, xK_Return), spawn "xdotool click 2")

    , ((controlMask .|. shiftMask,   xK_Down), spawn "xdotool mousemove_relative --   0  150")
    , ((controlMask .|. shiftMask,     xK_Up), spawn "xdotool mousemove_relative --   0 -150")
    , ((controlMask .|. shiftMask,   xK_Left), spawn "xdotool mousemove_relative -- -150   0")
    , ((controlMask .|. shiftMask,  xK_Right), spawn "xdotool mousemove_relative --  150   0")
    ] 
...
main :: IO ()
main = xmonad $ withNavigation2DConfig defaultNavigation2DConfig $ defaultConfig 
     { modMask      = mod4Mask
     , keys         = customKeys <+> {- comboKeys <+> -} keys defaultConfig
